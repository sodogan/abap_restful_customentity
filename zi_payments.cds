...
define custom entity ZI_PAYMENTS
{
  key DocumentNumber   : abap.numc(10);
      ...
      _ContractFiData  : association to parent zi_contract_fi_data on  $projection.Contract = _ContractFiData.Contract
                                                                         and $projection.Vendor   = _ContractFiData.Vendor;
}
